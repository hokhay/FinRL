...
DEFAULT_DATA_COLUMNS = ["date", "tic", "close", "volume"]

## stockstats technical indicator column names
## check https://pypi.org/project/stockstats/ for different names
TECHNICAL_INDICATORS_LIST = ["macd", "boll_ub", "boll_lb", "rsi_30", "cci_14", "cci_30", "dx_30", "close_30_sma", "close_60_sma"]
# TECHNICAL_INDICATORS_LIST = ["macd", "rsi_30", "cci_30", "dx_30"]
# TECHNICAL_INDICATORS_LIST = ["macd", "rsi_30", "boll_ub", "boll_lb",]
# TECHNICAL_INDICATORS_LIST = ["macd", "boll_ub", "boll_lb", "rsi_30", "cci_30", "dx_30",]


## Model Parameters
A2C_PARAMS = {"n_steps": 50, "ent_coef": 0.1, "learning_rate": 0.0007}
PPO_PARAMS = {
    "n_steps": 32,  # 2048
    "ent_coef": 0.2,
...
DDPG_PARAMS = {"batch_size": 1024, "buffer_size": 50000, "learning_rate": 0.001}
TD3_PARAMS = {"batch_size": 100, "buffer_size": 1000000, "learning_rate": 0.001}
SAC_PARAMS = {
    "batch_size": 64,  # 32
    "buffer_size": 260000,  # 110000
    "learning_rate": 0.00017,  # was 0.0001, good 0.00015
    "learning_starts": 100,
    "gamma": 0.9,  # 0.9
    "ent_coef": "auto_0.2",  # was auto_0.2
}
